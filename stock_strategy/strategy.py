...
if __name__ == '__main__':
    ...
    start = QA.QA_util_get_last_day(QA.QA_util_get_real_date(str(datetime.date.today())),20)
    ...
    #DMI.run_backtest()
    DMI = DMI(code=stock_pool_list, frequence='1min',strategy_id='stock_sim', send_wx=True)
    DMI.debug_sim()
